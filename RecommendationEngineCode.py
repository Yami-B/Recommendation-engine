...
with open('train_submissions.csv') as csv_file:
...
with open('problem_data.csv') as csv_file:
    csv_reader = csv.reader(csv_file)
    line_count = 0
    problems=[]
    level=[]
...
with open('soluce.csv','w') as csv_file1:
...
with open('soluce1.csv','w') as csv_file1:
            wr = csv.writer(csv_file1,lineterminator = '\n')
            for attempt in Attempts:
               wr.writerow([attempt])
